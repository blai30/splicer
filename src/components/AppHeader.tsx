  ...
  return (
    <header class="flex min-h-14 shrink-0 items-center justify-between rounded-lg border border-slate-200/60 bg-slate-50/40 px-4 py-2 backdrop-blur dark:border-slate-700/60 dark:bg-slate-900/40">
      ...
      <div class="flex items-center gap-2">
        <KeyboardLegend class="h-9 w-9 rounded-md text-slate-500 transition-colors hover:bg-slate-100 hover:duration-0 dark:text-slate-400 dark:hover:bg-slate-800" />
        <a
        ...
        <ThemeSwitcher class="h-9 w-9 rounded-md text-slate-500 transition-colors hover:bg-slate-100 hover:duration-0 dark:text-slate-400 dark:hover:bg-slate-800" />
      </div>
    </header>
  )
}
